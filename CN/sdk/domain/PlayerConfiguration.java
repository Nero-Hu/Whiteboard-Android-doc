...
public class PlayerConfiguration extends WhiteObject {
     ...
     * 获取 `Player` 实例的数据中心。
     *
     * @return `Player` 实例的数据中心。详见 { Region Region}。
     */
     ...
     * 设置 `Player` 实例的数据中心。
     *
     * 如果你不调用该方法，SDK 默认使用 { com.herewhite.sdk.WhiteSdkConfiguration WhiteSdkConfiguration} 中设置的数据中心。
     *
     * @param region `Player` 实例的数据中心。详见 { Region Region}。
     */
     ...
     * 获取本地用户的视角边界。
     *
     * @return 视角边界，详见 { CameraBound CameraBound}。
     */
     ...
     * 设置本地用户的视角边界。
     *
     * 该方法设置的视角边界必须和 { com.herewhite.sdk.RoomParams#setCameraBound(CameraBound)} 中设置视角边界一致。
     *
     * @param cameraBound 视角边界，详见 { CameraBound CameraBound}。
     */
