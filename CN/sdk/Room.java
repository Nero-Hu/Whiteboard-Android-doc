...
public class Room extends Displayer {
     ...
     *
     * @param delaySec 延时时长，单位为秒。取值必须大于等于 0。默认值为 0。
     */
     ...
     *
     * 在同时订阅音视频流和白板内容的场景中，你可以从音视频流附带的 SEI 帧中获取时间信息，
     * 并调用该方法设置远端白板内容在本地的显示时间，以确保音视频流和白板内容实时同步。
     *
     * @param utcMs 远端白板内容在本地显示的 Unix 时间戳，单位为毫秒。
     */
