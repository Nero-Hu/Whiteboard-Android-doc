...
/**
 * The `Displayer` class, which is the parent class of the {@link com.herewhite.sdk.Room Room} class.
 * The `Room` class can inherit the methods of the `Displayer` class.
 */
public class Displayer {
     ...
     * @since 2.3.0
     *
     * @note If the scene displays an image or dynamic PPT slide, ensure that the storage server of the image or the PPT slide supports cross-origin resource sharing;
