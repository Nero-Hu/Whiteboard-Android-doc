...
public class RoomParams extends WhiteObject {
     ...
     * @param uid Since v2.15.0. The unique identifier of a user in a string format. The maximum length is 1024 bytes.
     * If you upgrade the SDK to v2.15.0 or later, this parameter is required. Ensure that the `uid` of each user in the same room is unique.
     */
     ...
     *
     * @deprecated This method is deprecated. Use {@link RoomParams(String uuid, String roomToken, String uid, Object userPayload) RoomParams}[3/3] instead.
     *
     * @param uuid The unique identifier of the room. Ensure that the room UUID is the same as the one you use to generate the Room Token.
     * @param roomToken The Room Token for authentication.
     * @param uid Since v2.15.0. The unique identifier of a user in a string format. The maximum length is 1024 bytes.
